function [imgwr, ifv_ind,ifv_sub, trgmask] = tpswarp(img, outDim, Zp, Zs, interp, pRad, srcmask)
%
...
if nargin==7
    [imgwr,ifv_ind,ifv_sub,trgmask] = interp2d(X(:), Y(:), img, Xw, Yw, outH, outW, interp, pRad,srcmask);
else
    [imgwr,ifv_ind,ifv_sub] = interp2d(X(:), Y(:), img, Xw, Yw, outH, outW, interp, pRad);
end
return
