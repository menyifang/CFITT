function [optS] = init_opt(optS,src)
...
optS.useMultiscale = true;          % use multi-scale patch in cost
optS.histNum  = 100;                % quantify all distances into 100 bins
optS.numPSizeLvl = 5;               % the max scale L = 5

% === Method configuration ===
optS.useBiasCorrection = false;      % permit patch color correction
...
optS.numIter    = 20;                  % The initial iteration number, large hole might require
% more iterations
...
optS.automatch = 1; % whether use auto-keypoints matching, preciser results in manual
