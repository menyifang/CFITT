function [validPix, uvPix] = init_level(trgtextCur, srctextCur, prad, lockRandOn, lockRandSeed)
...
uvPix.color = trgtextCur(uvPix.ind);

% Get validPixels

[imgH, imgW] = size(srctextCur);
...
[validPix.color, validPix.colorInd] = sort(srctextCur(validPix.ind)+rand(1,validPix.numValidPix)*0.1);
